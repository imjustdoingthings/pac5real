...
function pace.FillEditorSettings(pnl)
	...
	shortcuts_description_text:SetColor(derma.GetSkinTable()["pac3_dark"] and Color(255,255,255) or Color(0,0,0))
	...
	bindcapture_text:SetColor(derma.GetSkinTable()["pac3_dark"] and Color(255,255,255) or Color(0,0,0))
...
function pace.FillEditorSettings2(pnl)
	...
	movement_binders_label:SetColor(derma.GetSkinTable()["pac3_dark"] and Color(255,255,255) or Color(0,0,0))
