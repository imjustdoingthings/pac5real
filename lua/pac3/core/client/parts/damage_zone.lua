...
local temp_damage_matrix = Matrix()
	...
	pac.AddHook(self.RenderingHook, "pace_draw_hitbox"..self.UniqueID, function()
		...
		elseif self.HitboxMode == "Cylinder" or self.HitboxMode == "CylinderHybrid" then
			...
			temp_damage_matrix:Identity()
			temp_damage_matrix:Translate(self:GetWorldPosition())
			temp_damage_matrix:Rotate(self:GetWorldAngles())
			cam.PushModelMatrix( temp_damage_matrix )
			obj:Draw()
			cam.PopModelMatrix()
